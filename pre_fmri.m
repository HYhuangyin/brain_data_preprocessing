clearvars;
root = 'E:\Homeworks\2018春季学期\功能磁共振成像\fmri课程实验数据\';
...
smoothRootPath = fullfile(root, '6.smooth');
...
for i = 1:numel(subs)
    ...
    for j = 1:numel(modes)
        ...
        matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.tpm = {'D:\Program Files\MATLAB\R2016b\toolbox\addtional_toolbox\spm12\tpm\TPM.nii'};
